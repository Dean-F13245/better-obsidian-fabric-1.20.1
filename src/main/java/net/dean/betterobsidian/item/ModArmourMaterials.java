...
public enum ModArmourMaterials implements ArmorMaterial {
    OBSIDIAN("obsidian",37,new int[] {3,8,6,3}, 13,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,2.5f , 0.2F, () -> Ingredient.ofItems(ModItems.OBSIDIAN_INGOT));
    ;
    ...
    public String getName() {
        return BetterObsidian.MOD_ID + ":" + this.name;
    }
